...
public sealed class UpdatePreferencesCommandValidatorTests
{
    ...
    {
        Assert.True(_validator.Validate(new UpdatePreferencesCommand([], [], [], [], null, null, null)).IsValid);
    }
    ...
    {
        Assert.True(_validator.Validate(new UpdatePreferencesCommand(["Developer"], ["Paris"], ["CDI"], [mode],
    ...
    {
        var command = new UpdatePreferencesCommand([], [], [], [], null, null, null);
