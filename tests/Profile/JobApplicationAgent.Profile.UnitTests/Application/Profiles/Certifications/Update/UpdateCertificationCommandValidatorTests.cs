...
public sealed class UpdateCertificationCommandValidatorTests
{
    private readonly UpdateCertificationCommandValidator _validator = new();
    ...
    public void Validate_ShouldAcceptOptionalFieldsAndSameDayExpiry(string? url)
    {
        ...
        var command = new UpdateCertificationCommand("Azure", "Microsoft", date, date, null, url);
